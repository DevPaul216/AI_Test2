    ...
    if selected_option is not None:
        ...
        if "websearch" in selected_option:
            with st.container(border=True):
                ...
                number_entries_used = st.number_input(label="Number of websites searched (1-10)", min_value=1, max_value=10,
                                                      value=2)
...
def generate_artifacts(element_name):
    ...
    selected_elements = {}
    with st.expander("Select individual elements from selected templates"):
